...
function YouTubeToHtml5() {
  ...
  for (var b in ((this.hooks = {}), (this.options = {}), this.defaultOptions))
...
(YouTubeToHtml5.prototype.defaultOptions = {
  ...
  (YouTubeToHtml5.prototype.addHook = function (a, b) {
    a in this.globalHooks || (this.globalHooks[a] = []),
      ...
      "global" in b && b.global
        ? this.globalHooks[a].push(b)
        : this.hooks[a].push(b);
  }),
  (YouTubeToHtml5.prototype.addAction = function (a, b) {
    ...
    this.addHook("actions", { name: a, callback: b, priority: c, global: d });
  }),
  (YouTubeToHtml5.prototype.doAction = function (a) {
    for (
      var b = this.getHooks("actions", a),
        c = arguments.length,
        d = Array(1 < c ? c - 1 : 0),
        e = 1;
      e < c;
  ...
  (YouTubeToHtml5.prototype.addFilter = function (a, b) {
    var c = 2 < arguments.length && arguments[2] !== void 0 ? arguments[2] : 10,
      d = !!(3 < arguments.length && arguments[3] !== void 0) && arguments[3];
    this.addHook("filters", { name: a, callback: b, priority: c, global: d });
  }),
  (YouTubeToHtml5.prototype.applyFilters = function (a, b) {
    for (
      var c = this.getHooks("filters", a),
        d = arguments.length,
        e = Array(2 < d ? d - 2 : 0),
        f = 2;
      f < d;
  ...
  (YouTubeToHtml5.prototype.getAllowedFormats = function () {
    ...
    return (
      Array.isArray(this.options.formats)
        ? (a = this.options.formats)
        : this.itagMap[this.options.formats]
        ? (a = [this.options.formats])
        : "*" === this.options.formats &&
          (a = Object.values(this.itagMap).sort()),
      a
    );
  }),
    ...
    return (
      a &&
        ...
        HTMLCollection.prototype.isPrototypeOf(a)
          ? (b = a)
          : "object" === _typeof(a) && "nodeType" in a && a.nodeType
          ? (b = [a])
          : (b = document.querySelectorAll(this.options.selector))),
      (b = Array.from(b || "")),
  ...
  (YouTubeToHtml5.prototype.canPlayType = function (a) {
    ...
    var c =
      b && "function" == typeof b.canPlayType ? b.canPlayType(a) : "unknown";
    return c ? c : "no";
  }),
  (YouTubeToHtml5.prototype.parseYoutubeMeta = function (a) {
    ...
    var e = a.data || {};
    return (
      (e = this.applyFilters("api.response", e, a)),
      e.hasOwnProperty("url_encoded_fmt_stream_map") &&
        (c = c.concat(
          e.url_encoded_fmt_stream_map.split(",").map(function (a) {
            return b.parseUriString(a);
          })
        )),
      e.player_response && e.player_response.streamingData &&
        e.player_response.streamingData.formats &&
        (c = c.concat(e.player_response.streamingData.formats)),
      e.hasOwnProperty("adaptive_fmts") &&
        (c = c.concat(
          e.adaptive_fmts.split(",").map(function (a) {
            return b.parseUriString(a);
          })
        )),
      e.player_response && e.player_response.streamingData &&
        e.player_response.streamingData.adaptiveFormats &&
        (c = c.concat(e.player_response.streamingData.adaptiveFormats)),
      c.forEach(function (a) {
        if (a && "itag" in a && b.itagMap[a.itag]) {
          ...
          if (
            ("url" in a && a.url ? (c.url = a.url) : "signatureCipher" in a,
            "audioQuality" in a && a.audioQuality && (c.hasAudio = !0),
            (c.label =
              "qualityLabel" in a && a.qualityLabel
                ? a.qualityLabel
                : b.itagMap[a.itag]),
            "mimeType" in a)
          ) {
            ...
            e[1] && (c.type = e[1]),
              e[2] && (c.mime = e[2]),
              (c.browserSupport = b.canPlayType(
                "".concat(c.type, "/").concat(c.mime)
              ));
          }
          c.url && d.push(c);
        }
            ...
            if (c) {
              ...
              if (d && Array.isArray(d)) {
                (d = d.filter(function (b) {
                  ...
                  d.sort(function (c, a) {
                    var b = { unknown: -1, no: -1, maybe: 0, probably: 1 };
                ...
                for (
                  var f,
                    ...
                    k = function (a) {
                      ...
                      if (e && e.length)
                        return (h = e.shift()), (j = c), "break";
                    },
                    l = 0;
                  l < g.length && ((f = k(l)), "break" !== f);
                  l++
                );
                ...
                h && "url" in h && h.url && (m.src = h.url),
                  h.type &&
                    ...
                    h.mime &&
                    "unknown" !== h.mime &&
                    (m.type = "".concat(h.type, "/").concat(h.mime)),
                  (m.src = b.applyFilters("video.source", m.src, h, a, j, d)),
                  m.src &&
                  "function" == typeof m.src.toString &&
                  m.src.toString().length
                    ? ((a.src = m.src),
                      m.type && m.type.length && (a.type = m.type))
                    : console.warn(
                        "YouTubeToHtml5 unable to load video for ID: ".concat(e)
                      );
              }
            }
          })
